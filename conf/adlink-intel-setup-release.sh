...
if [ -f $PWD/../meta-adlink-amd/conf/$CONF-conf/bblayers.conf.sample -a -f conf/bblayers.conf ]; then
  cp $PWD/../meta-adlink-amd/conf/$CONF-conf/bblayers.conf.sample  conf/bblayers.conf
fi
if [ -f $PWD/../meta-adlink-amd/conf/$CONF-conf/local.conf.sample -a -f conf/local.conf ]; then
  cp $PWD/../meta-adlink-amd/conf/$CONF-conf/local.conf.sample  conf/local.conf
fi
